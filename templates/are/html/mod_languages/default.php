...
<?php if ($headerText) : ?>
    <div class="mod-languages__pretext pretext">
    ...
    <div class="mod-languages__select btn-group">
        ...
        <ul aria-labelledby="language_picker_des_<?php echo $module->id; ?>" class="lang-block dropdown-menu">
            ...
            <?php foreach ($list as $language) : ?>
                ...
                <?php if (!$language->active) : ?>
                    <li>
                        <a class="language" <?php echo $lbl; ?> href="<?php echo htmlspecialchars_decode(htmlspecialchars($language->link, ENT_QUOTES, 'UTF-8'), ENT_NOQUOTES); ?>">
                            <?php if ($params->get('dropdownimage', 1) && ($language->image)) : ?>
                                <?php echo HTMLHelper::_('image', 'mod_languages/' . $language->image . '.gif', $params->get('full_name') ? '' : $language->title_native, null, true); ?>
                            <?php endif; ?>
                            <?php echo $params->get('full_name', 1) ? $language->title_native : strtoupper($language->sef); ?>
                ...
                <?php elseif ($params->get('show_active', 1)) : ?>
                    ...
                    <li class="lang-active">
                        <a class="language" aria-current="true" <?php echo $lbl; ?> href="<?php echo htmlspecialchars_decode(htmlspecialchars($base, ENT_QUOTES, 'UTF-8'), ENT_NOQUOTES); ?>">
                            <?php if ($params->get('dropdownimage', 1) && ($language->image)) : ?>
                                <?php echo HTMLHelper::_('image', 'mod_languages/' . $language->image . '.gif', $params->get('full_name') ? '' : $language->title_native, null, true); ?>
                            <?php endif; ?>
                            <?php echo $params->get('full_name', 1) ? $language->title_native : strtoupper($language->sef); ?>
...
<?php else : ?>
    <ul style="list-style-type: none;" aria-labelledby="language_picker_des_<?php echo $module->id; ?>" class="mod-languages__list <?php echo $params->get('inline', 1) ? 'lang-inline' : 'lang-block'; ?>">
        ...
        <?php foreach ($list as $language) : ?>
            ...
            <?php if (!$language->active) : ?>
                <li>
                    <i class="fa fa-globe" style="color: #73a79c;"></i>
                    <a class="language" <?php echo $lbl; ?> href="<?php echo htmlspecialchars_decode(htmlspecialchars($language->link, ENT_QUOTES, 'UTF-8'), ENT_NOQUOTES); ?>">
